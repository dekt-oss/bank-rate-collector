...
Revision ID: 31f56a26f628
Revises: 
Create Date: 2026-08-05 07:27:23.479205
"""
...
def upgrade() -> None:
    ...
    sa.Column('base_rate', rate_monitor.db.types.Rate(length=8), nullable=True),
    sa.Column('max_rate', rate_monitor.db.types.Rate(length=8), nullable=True),
    ...
    with op.batch_alter_table('rate_observations', schema=None) as batch_op:
        batch_op.create_index('ix_rate_observations_run_id', ['run_id'], unique=False)
    ...
    sa.Column('add_rate', rate_monitor.db.types.Rate(length=8), nullable=True),
...
def downgrade() -> None:
    ...
    with op.batch_alter_table('rate_observations', schema=None) as batch_op:
        batch_op.drop_index('ix_rate_observations_run_id')
