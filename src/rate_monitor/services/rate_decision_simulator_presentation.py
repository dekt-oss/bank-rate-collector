...
@media(max-width:620px){.strategy-rate-decision-simulator{padding:10px}.rds-head{display:block}.rds-safety{display:inline-block;margin-top:7px}.rds-tabs{display:grid;grid-template-columns:1fr 1fr;width:100%}.rds-metrics{grid-template-columns:1fr}.rds-controls label{width:100%;justify-content:space-between}.rds-controls input{width:132px}.rds-size-peer-section{padding:10px}.rds-size-peer-meta{display:grid;grid-template-columns:1fr}.rds-size-peer-meta span{width:100%;border-radius:8px}.rds-size-peer-wrap{overflow:visible;border:0}.rds-size-peer-table,.rds-size-peer-table tbody,.rds-size-peer-table tr,.rds-size-peer-table td{display:block;width:100%;min-width:0}.rds-size-peer-table thead{display:none}.rds-size-peer-table tbody{display:grid;gap:7px}.rds-size-peer-table tr{padding:8px 9px;border:1px solid rgba(91,47,100,.09);border-radius:10px;background:#fcfafc;overflow:hidden}.rds-size-peer-table td{display:flex;align-items:flex-start;justify-content:space-between;gap:10px;padding:5px 0;border:0!important;text-align:right!important;white-space:normal;overflow-wrap:anywhere}.rds-size-peer-table td::before{content:attr(data-label);flex:0 0 76px;color:#88798a;font-size:9px;text-align:left}.rds-size-peer-table td>b,.rds-size-peer-table .rds-size-similarity>span{min-width:0}.rds-size-similarity b,.rds-size-similarity small{text-align:right}.rds-size-peer-table td[data-label="기관"] b{font-size:9.5px}.rds-size-peer-count{font-size:9px}}
</style>
"""
