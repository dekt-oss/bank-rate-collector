...
REGION_GROUPS: dict[str, str] = {
    ...
    "광주": "전라", "전북": "전라", "전남": "전라",
    # 원천이 같은 땅을 네 이름으로 준다 — 광주 3,112행 · 전남 8,039행 ·
    # 광주·전남 3,406행 · 전남광주통합특별시 19,225행 (2026-08-10 실측).
    # 매핑에 없으면 «기타»라는 권역이 화면에 생기는데, 그게 어디인지
    # 아무도 모른다. 실제로 «광주·전남»만 빠져 있어서 3,406행이 그렇게 샜다.
    "전남광주통합특별시": "전라", "광주·전남": "전라",
    "대구": "경북", "경북": "경북",
    "울산": "경남", "경남": "경남",
    "부산": "부산",
    "제주": "제주",
