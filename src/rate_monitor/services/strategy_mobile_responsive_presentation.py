...
@media(max-width:760px){
  ...
  .workspace-decision .simform*,.workspace-decision .simform*::before,.workspace-decision .simform*::after{box-sizing:border-box;min-width:0;max-width:100%}
  ...
  .workspace-decision input[type="range"]{min-width:0;width:100%;margin:0}
