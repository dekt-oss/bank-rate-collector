...
.evidence-card{border-color:rgba(91,47,100,.10);border-radius:11px;background:#fff;box-shadow:0 6px 18px rgba(77,45,88,.05)}.evidence-card.active{border-color:var(--accent-line);background:linear-gradient(145deg,#FFF,#FCF2F7)}.evidence-head strong{color:#392A3B}.evidence-head em,.evidence-grid{color:#776B79}.evidence-grid b{color:#4C3A50}.evidence-reason{color:#896C43}
.ranking-basis:before{border-color:var(--accent-line);color:#8C3F69;background:#FCF1F6}
