...
.psv2{display:grid;gap:14px;margin-top:14px;padding:14px;border:1px solid rgba(91,47,100,.16);border-radius:15px;background:linear-gradient(145deg,#fff,#fbf7fa);box-shadow:0 8px 24px rgba(77,45,88,.06)}
.psv2 *{box-sizing:border-box}.psv2-head{display:flex;align-items:flex-start;justify-content:space-between;gap:14px}.psv2-head h3{margin:0;color:#39273e;font-size:13px;letter-spacing:-.02em}.psv2-head p{margin:4px 0 0;color:#705f73;font-size:10.5px;line-height:1.55}.psv2-badge{flex:none;padding:5px 8px;border:1px solid rgba(91,47,100,.18);border-radius:999px;background:#f6eef6;color:#5b2f64;font-size:10.5px;font-weight:800;letter-spacing:.04em}
.psv2-decision{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:9px}.psv2-card{min-width:0;padding:12px;border:1px solid rgba(91,47,100,.12);border-radius:12px;background:#fff;box-shadow:0 4px 14px rgba(77,45,88,.035)}.psv2-card.market{border-color:rgba(78,150,117,.20);background:#f3faf6}.psv2-card.scenario{border-color:rgba(169,116,26,.20);background:#fff9eb}.psv2-kicker{display:block;margin-bottom:7px;color:#725f75;font-size:10.5px;font-weight:800;letter-spacing:.06em;text-transform:uppercase}.psv2-card strong{display:block;color:#36243b;font:800 17px/1.15 var(--mono)}.psv2-card strong.gold{color:#96661d}.psv2-card strong.green{color:#2e7d5b}.psv2-card small{display:block;margin-top:5px;color:#6c596f;font-size:10.5px;line-height:1.5}.psv2-card .minor{margin-top:7px;padding-top:7px;border-top:1px solid rgba(91,47,100,.08);color:#725f75;font:700 10.5px var(--mono)}
.psv2-separator{display:grid;grid-template-columns:1fr auto 1fr;align-items:center;gap:9px;color:#776679;font-size:10.5px;font-weight:800;letter-spacing:.04em}.psv2-separator:before,.psv2-separator:after{content:"";height:1px;background:linear-gradient(90deg,transparent,rgba(91,47,100,.18))}.psv2-separator:after{transform:scaleX(-1)}
.psv2-grid{display:grid;grid-template-columns:minmax(0,.88fr) minmax(0,1.12fr);gap:10px}.psv2-panel{min-width:0;padding:12px;border:1px solid rgba(91,47,100,.10);border-radius:12px;background:#fff}.psv2-panel-head{display:flex;align-items:flex-start;justify-content:space-between;gap:10px;margin-bottom:10px}.psv2-panel-head b{color:#47334c;font-size:10.5px}.psv2-panel-head span{color:#78677a;font-size:10.5px;line-height:1.45;text-align:right}
.psv2-ladder{position:relative;height:198px;margin:4px 8px 0}.psv2-ladder-line{position:absolute;left:26px;top:10px;bottom:10px;width:2px;border-radius:2px;background:linear-gradient(180deg,rgba(169,116,26,.58),rgba(78,150,117,.46),rgba(91,47,100,.18))}.psv2-rung{position:absolute;left:0;right:0;transform:translateY(-50%);display:grid;grid-template-columns:18px 1fr auto;align-items:center;gap:8px}.psv2-rung i{justify-self:end;width:8px;height:8px;border:2px solid #9a889d;border-radius:50%;background:#fff;box-shadow:0 0 0 3px rgba(91,47,100,.05)}.psv2-rung.current i{border-color:#7b6680}.psv2-rung.proposal i{width:10px;height:10px;border-color:#a9741a;background:#fff9eb;box-shadow:0 0 0 4px rgba(169,116,26,.10)}.psv2-rung.cutoff i{border-color:#4e9675}.psv2-rung.max i{border-color:#a9741a}.psv2-rung label{min-width:0;color:#69586d;font-size:10.5px;font-weight:720;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.psv2-rung strong{color:#3d2b42;font:760 10.5px var(--mono)}.psv2-rung.proposal label,.psv2-rung.proposal strong{color:#96661d}.psv2-rung.same label:after{content:" · 동률";color:#8a6f36}
.psv2-crowding{display:grid;grid-template-columns:repeat(4,1fr);gap:6px;margin-top:10px}.psv2-mini{padding:8px;border:1px solid rgba(91,47,100,.08);border-radius:9px;background:#fcfafc}.psv2-mini span{display:block;color:#756478;font-size:10.5px}.psv2-mini b{display:block;margin-top:4px;color:#433047;font:760 10.5px var(--mono)}
.psv2-chart-wrap{position:relative;min-height:220px}.psv2-chart{display:block;width:100%;height:220px;overflow:visible}.psv2-chart .grid{stroke:rgba(91,47,100,.08);stroke-width:1}.psv2-chart .axis{fill:#756478;font:10.5px var(--mono)}.psv2-chart .band{fill:rgba(78,150,117,.09);stroke:none}.psv2-chart .base-line{fill:none;stroke:#4e9675;stroke-width:2.2}.psv2-chart .ref{stroke:rgba(169,116,26,.30);stroke-width:1;stroke-dasharray:3 3}.psv2-chart .ref.market{stroke:rgba(78,150,117,.24)}.psv2-chart .point{fill:#fff;stroke:#4e9675;stroke-width:2}.psv2-chart .point.proposal{stroke:#a9741a;stroke-width:2.5}.psv2-chart .label{fill:#69586d;font:10.5px var(--sans)}.psv2-chart-legend{display:flex;flex-wrap:wrap;gap:6px 12px;margin-top:5px;color:#756478;font-size:10.5px}.psv2-chart-legend b{color:#2e7d5b}.psv2-chart-legend em{font-style:normal;color:#96661d}
.psv2-empty{padding:18px 12px;border:1px dashed rgba(91,47,100,.16);border-radius:10px;background:#fcfafc;color:#756478;font-size:10.5px;line-height:1.6;text-align:center}.psv2-disclosure{padding:9px 11px;border-left:2px solid rgba(169,116,26,.48);border-radius:0 8px 8px 0;background:#fff8e9;color:#7b632f;font-size:10.5px;line-height:1.55}.psv2-disclosure b{color:#8d6119}
.psv2-table-wrap{overflow:auto;border:1px solid rgba(91,47,100,.09);border-radius:11px;background:#fff}.psv2-table{width:100%;min-width:850px;border-collapse:collapse}.psv2-table th{padding:8px 9px;border-bottom:1px solid rgba(91,47,100,.10);background:#faf7fa;color:#725f75;font-size:10.5px;text-align:right;white-space:nowrap}.psv2-table th:first-child,.psv2-table td:first-child{text-align:left}.psv2-table td{padding:9px;border-bottom:1px solid rgba(91,47,100,.06);color:#4e3c52;font:700 10.5px var(--mono);text-align:right;white-space:nowrap}.psv2-table tbody tr:last-child td{border-bottom:0}.psv2-table tr.current{background:#f3faf6}.psv2-table tr.proposal{background:#fff9eb}.psv2-table .rate-label{display:block;color:#3b293f;font:780 10.5px var(--sans)}.psv2-table .rate-note{display:block;margin-top:2px;color:#78677a;font:10.5px var(--sans)}.psv2-table .gold{color:#96661d}.psv2-table .green{color:#2e7d5b}.psv2-table .muted{color:#817184}.psv2-table-foot{display:flex;flex-wrap:wrap;gap:6px 12px;margin-top:7px;color:#756478;font-size:10.5px}.psv2-error{padding:10px;border:1px solid rgba(193,108,108,.22);border-radius:10px;background:#fff7f7;color:#9b5f5f;font-size:10.5px;line-height:1.55}
