...
.rate-response-caveat{margin:-2px 0 12px;padding:10px 12px;border:1px solid rgba(212,179,111,.26);border-radius:10px;background:rgba(112,83,36,.13);color:#c7b17e;font-size:9.5px;line-height:1.55}.rate-response-caveat b{color:#e1c98f}.rate-response-wrap{display:grid;gap:9px;padding:11px;border:1px solid rgba(128,200,166,.18);border-radius:11px;background:rgba(8,25,20,.35)}.rate-response-head{display:flex;align-items:flex-start;justify-content:space-between;gap:12px}.rate-response-head b{font-size:10.5px;color:#dbe8e1}.rate-response-head span{font-size:9px;color:#6f8479}.rate-response-table{width:100%;min-width:720px;border-collapse:collapse}.rate-response-table th{padding:7px 8px;border-bottom:1px solid var(--line);color:#71837a;font-size:8.5px;text-align:right}.rate-response-table th:first-child,.rate-response-table td:first-child{text-align:left}.rate-response-table td{padding:9px 8px;border-bottom:1px solid rgba(213,225,219,.06);font:740 9.5px var(--mono);text-align:right}.rate-response-table tbody tr:last-child td{border-bottom:0}.rate-response-table tr.current{background:rgba(128,200,166,.055)}.rate-response-table tr.proposal{background:rgba(212,179,111,.055)}.rate-response-table .scenario-name{display:block;color:#dbe5df;font:760 9.5px var(--sans)}.rate-response-table .scenario-note{display:block;margin-top:2px;color:#607269;font:8.5px var(--sans)}.rate-response-table .positive{color:var(--green)}.rate-response-table .negative{color:var(--red)}.rate-response-table .cost{color:var(--gold)}.rate-response-empty{padding:13px;border:1px dashed var(--line);border-radius:9px;color:#71837a;font-size:9px;line-height:1.55;text-align:center}.rate-response-scroll{overflow:auto}.rate-response-foot{display:flex;flex-wrap:wrap;gap:6px 12px;color:#63766c;font-size:8.8px}.market-position-reference{margin:0}.market-position-reference summary{cursor:pointer;list-style:none;padding:8px 10px;border:1px solid var(--line);border-radius:9px;background:rgba(4,14,11,.18);color:#81938a;font-size:9px;font-weight:760}.market-position-reference summary::-webkit-details-marker{display:none}.market-position-reference summary:after{content:" 펼치기";float:right;color:#607269;font-weight:500}.market-position-reference[open] summary:after{content:" 접기"}.market-position-reference-body{display:grid;gap:10px;padding-top:10px}@media(max-width:760px){.rate-response-table{min-width:650px}.rate-response-head{flex-direction:column}}
</style>
"""
