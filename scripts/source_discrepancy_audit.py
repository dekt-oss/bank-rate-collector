...
def main() -> int:
    ...
    print(f"agree / date differs   : {summary['agree_rate_date_diff']}")
    print(f"rate mismatch          : {summary['rate_mismatch']}")
    print(f"mismatch / date differs: {summary['rate_mismatch_date_diff']}")
    print(f"incomplete rate        : {summary['incomplete_rate']}")
