...
def main() -> int:
    ...
    print(f"max agree / source date differs  : {summary['agree_rate_date_diff']}")
    print(f"max agree / source date unknown  : {summary['agree_rate_date_unknown']}")
    print(f"max mismatch              : {summary['rate_mismatch']}")
    print(f"max mismatch / source date differs: {summary['rate_mismatch_date_diff']}")
    print(f"max mismatch / source date unknown: {summary['rate_mismatch_date_unknown']}")
