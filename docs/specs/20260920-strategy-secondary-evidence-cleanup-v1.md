...
선행 상태: PR #338 + #340 merge 완료, 최신 main 기준 독립 후속
...
이 작업은 최신 `main`에서 독립적으로 수행한다.

- PR #338 Lean IA v3: merge 완료
- PR #340 progressive disclosure density reduction: merge 완료
- 기존 stacked PR #339는 최신 main과 diverged되어 직접 merge하지 않는다.
- 본 작업은 #339의 유효 변경만 최신 main에 재이식한다.
- 자동 merge하지 않는다.
