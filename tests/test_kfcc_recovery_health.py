"""관리자 health가 same-workflow KFCC recovery 결과를 최종 source 결과로 사용한다."""
...
def test_kfcc_recovery_success_supersedes_first_failure() -> None:
    script = f"""
      ...
      const core = {{
        id: 801, run_number: 801, event: 'schedule', status: 'completed', conclusion: 'success',
      ...
      const kfcc = {{
        id: 802, run_number: 802, event: 'schedule', status: 'completed', conclusion: 'success',
